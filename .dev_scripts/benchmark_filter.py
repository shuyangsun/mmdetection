...
def parse_args():
    ...
    parser.add_argument(
        "--basic-arch", action="store_true", help="to train models in basic arch"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model-options", nargs="+", help="custom options to special model benchmark"
    )
    parser.add_argument(
        "--out",
        type=str,
...
datasets_root = ["wider_face", "pascal_voc", "cityscapes", "lvis", "deepfashion"]
