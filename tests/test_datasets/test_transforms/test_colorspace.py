...
class TestColorTransform(unittest.TestCase):
    ...
    def test_repr(self):
        transform = ColorTransform(level=10, prob=1.0)
        self.assertEqual(
            repr(transform),
            ("ColorTransform(prob=1.0, " "level=10, " "min_mag=0.1, " "max_mag=1.9)"),
        )
...
class TestColor(unittest.TestCase):
    ...
    def test_repr(self):
        transform = Color(level=10, prob=1.0)
        self.assertEqual(
            repr(transform),
            ("Color(prob=1.0, " "level=10, " "min_mag=0.1, " "max_mag=1.9)"),
        )
...
class TestBrightness(unittest.TestCase):
    ...
    def test_brightness(self):
        ...
        check_result_same(self.results_mask, results_wo_brightness, self.check_keys)
        # test case when level=0
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            repr(transform),
            ("Brightness(prob=1.0, " "level=10, " "min_mag=0.1, " "max_mag=1.9)"),
        )
...
class TestContrast(unittest.TestCase):
    ...
    def test_contrast(self):
        ...
        check_result_same(self.results_mask, results_wo_contrast, self.check_keys)
        # test case when level=0
    ...
    def test_repr(self):
        transform = Contrast(level=10, prob=1.0)
        self.assertEqual(
            repr(transform),
            ("Contrast(prob=1.0, " "level=10, " "min_mag=0.1, " "max_mag=1.9)"),
        )
...
class TestSharpness(unittest.TestCase):
    ...
    def test_sharpness(self):
        ...
        check_result_same(self.results_mask, results_wo_sharpness, self.check_keys)
        # test case when level=0
    ...
    def test_repr(self):
        transform = Sharpness(level=10, prob=1.0)
        self.assertEqual(
            repr(transform),
            ("Sharpness(prob=1.0, " "level=10, " "min_mag=0.1, " "max_mag=1.9)"),
        )
...
class TestSolarize(unittest.TestCase):
    ...
    def test_solarize(self):
        ...
        check_result_same(self.results_mask, results_wo_solarize, self.check_keys)
        # test case when level=0
        transform = Solarize(prob=1.0, level=0)
        transform(copy.deepcopy(self.results_mask))

    def test_repr(self):
        transform = Solarize(level=10, prob=1.0)
        self.assertEqual(
            repr(transform),
            ("Solarize(prob=1.0, " "level=10, " "min_mag=0.0, " "max_mag=256.0)"),
        )
...
class TestSolarizeAdd(unittest.TestCase):
    ...
    def test_solarize(self):
        ...
        check_result_same(self.results_mask, results_wo_solarizeadd, self.check_keys)
        # test case when level=10
        transform = SolarizeAdd(prob=1.0, level=10)
        transform(copy.deepcopy(self.results_mask))

    def test_repr(self):
        transform = SolarizeAdd(level=10, prob=1.0)
        self.assertEqual(
            repr(transform),
            ("SolarizeAdd(prob=1.0, " "level=10, " "min_mag=0.0, " "max_mag=110.0)"),
        )
...
class TestPosterize(unittest.TestCase):
    ...
    def test_posterize(self):
        ...
        check_result_same(self.results_mask, results_wo_posterize, self.check_keys)
        # test case when level=0
        transform = Posterize(prob=1.0, level=0)
        transform(copy.deepcopy(self.results_mask))

    def test_repr(self):
        transform = Posterize(level=10, prob=1.0)
        self.assertEqual(
            repr(transform),
            ("Posterize(prob=1.0, " "level=10, " "min_mag=0.0, " "max_mag=4.0)"),
        )
...
class TestEqualize(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            repr(transform),
            ("Equalize(prob=1.0, " "level=None, " "min_mag=0.1, " "max_mag=1.9)"),
        )
...
class TestAutoContrast(unittest.TestCase):
    ...
    def test_autocontrast(self):
        ...
        check_result_same(self.results_mask, results_wo_autocontrast, self.check_keys)
        # test case when translation is called
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            repr(transform),
            ("AutoContrast(prob=1.0, " "level=None, " "min_mag=0.1, " "max_mag=1.9)"),
        )
...
class TestInvert(unittest.TestCase):
    ...
    def test_invert(self):
        ...
        check_result_same(self.results_mask, results_wo_invert, self.check_keys)
        # test case when translation is called
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            repr(transform),
            ("Invert(prob=1.0, " "level=None, " "min_mag=0.1, " "max_mag=1.9)"),
        )
