...
class TestAutoAugment(unittest.TestCase):
    ...
    def test_autoaugment(self):
        ...
        results_brightness = transform_brightness(copy.deepcopy(self.results_mask))
        ...
        results_contrasted = transform_contrast(copy.deepcopy(self.results_mask))
        ...
        results_sharpness = transform_sharpness(copy.deepcopy(self.results_mask))
        ...
        results_solarized = transform_solarize(copy.deepcopy(self.results_mask))
        ...
        results_solarizeadded = transform_solarizeadd(copy.deepcopy(self.results_mask))
        ...
        results_posterized = transform_posterize(copy.deepcopy(self.results_mask))
        ...
        results_equalized = transform_equalize(copy.deepcopy(self.results_mask))
        ...
        results_autocontrast = transform_autocontrast(copy.deepcopy(self.results_mask))
...
class TestRandAugment(unittest.TestCase):
    ...
    def test_randaugment(self):
        ...
        aug_space = [[dict(type="Rotate", prob=1.0, level=10, reversal_prob=0.0)]]
