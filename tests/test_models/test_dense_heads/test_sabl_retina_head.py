...
class TestSABLRetinaHead(TestCase):
    def test_sabl_retina_head(self):
        ...
        one_gt_losses = sabl_retina_head.loss_by_feat(*outs, [gt_instances], img_metas)
        ...
        self.assertGreater(onegt_box_cls_loss, 0, "box loss should be non-zero")
        self.assertGreater(onegt_box_reg_loss, 0, "centerness loss should be non-zero")
