...
class TestATSSHead(TestCase):
    def test_atss_head_loss(self):
        ...
        empty_gt_losses = atss_head.loss_by_feat(
        ...
        one_gt_losses = atss_head.loss_by_feat(
            cls_scores, bbox_preds, centernesses, [gt_instances], img_metas
        )
        ...
        self.assertGreater(
            onegt_centerness_loss.item(), 0, "centerness loss should be non-zero"
        )
