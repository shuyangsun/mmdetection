...
class TestLDHead(TestCase):
    def test_ld_head_loss(self):
        ...
        empty_gt_losses = ld_head.loss_by_feat(
            cls_scores,
            bbox_preds,
            [gt_instances],
            img_metas,
        ...
        self.assertGreaterEqual(
            empty_ld_loss.item(), 0, "ld loss should be non-negative"
        )
        ...
        one_gt_losses = ld_head.loss_by_feat(
            cls_scores,
            bbox_preds,
            [gt_instances],
            img_metas,
        ...
        ignore_gt_losses = ld_head.loss_by_feat(
            cls_scores,
            bbox_preds,
            [gt_instances],
            img_metas,
        ...
        self.assertEqual(
            ignore_box_loss.item(), 0, "gt bbox ignored loss should be zero"
        )
        ...
        not_ignore_gt_losses = ld_head.loss_by_feat(
            cls_scores,
            bbox_preds,
            [gt_instances],
            img_metas,
        ...
        self.assertGreaterEqual(
            not_ignore_box_loss.item(), 0, "gt bbox not ignored loss should be non-zero"
        )
