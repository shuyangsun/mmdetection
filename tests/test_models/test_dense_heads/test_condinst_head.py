...
class TestCondInstHead(TestCase):
    def test_condinst_bboxhead_loss(self):
        ...
        cls_scores, bbox_preds, centernesses, param_preds = condinst_bboxhead.forward(
            feats
        )
        ...
        one_gt_losses = condinst_bboxhead.loss_by_feat(
            cls_scores, bbox_preds, centernesses, param_preds, [gt_instances], img_metas
        )
        ...
        self.assertGreater(onegt_ctr_loss, 0, "centerness loss should be non-zero")
        ...
        self.assertGreater(ctrsamp_ctr_loss, 0, "centerness loss should be non-zero")
        ...
        self.assertGreater(normbox_ctr_loss, 0, "centerness loss should be non-zero")
    ...
    def test_condinst_maskhead_loss(self):
        ...
        _ = condinst_bboxhead.loss_by_feat(
            cls_scores, bbox_preds, centernesses, param_preds, [gt_instances], img_metas
        )
