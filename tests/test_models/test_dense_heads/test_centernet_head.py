...
class TestCenterNetHead(TestCase):
    def test_center_head_loss(self):
        ...
        empty_gt_losses = centernet_head.loss_by_feat(
            center_out, wh_out, offset_out, [gt_instances], img_metas
        )
        ...
        one_gt_losses = centernet_head.loss_by_feat(
            center_out, wh_out, offset_out, [gt_instances], img_metas
        )
    ...
    def test_centernet_head_get_targets(self):
        ...
        gt_bboxes = [
            torch.Tensor([[10, 20, 200, 240], [40, 50, 100, 200], [10, 20, 100, 240]])
        ]
        ...
        targets, _ = centernet_head.get_targets(
            gt_bboxes, gt_labels, self.feat_shape, img_metas[0]["img_shape"]
        )
    ...
    def test_centernet_head_get_results(self):
        ...
        detections = centernet_head.predict_by_feat(
            [center_target],
            [wh_target],
            [offset_target],
            img_metas,
