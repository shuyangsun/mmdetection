...
class TestFCOSHead(TestCase):
    def test_fcos_head_loss(self):
        ...
        empty_gt_losses = fcos_head.loss_by_feat(
            cls_scores, bbox_preds, centernesses, [gt_instances], img_metas
        )
        ...
        one_gt_losses = fcos_head.loss_by_feat(
            cls_scores, bbox_preds, centernesses, [gt_instances], img_metas
        )
        ...
        ctrsamp_losses = fcos_head.loss_by_feat(
            cls_scores, bbox_preds, centernesses, [gt_instances], img_metas
        )
        ...
        normbox_losses = fcos_head.loss_by_feat(
            cls_scores, bbox_preds, centernesses, [gt_instances], img_metas
        )
