...
class TestMaskFormer(unittest.TestCase):
    ...
    def _create_model_cfg(self):
        ...
        model_cfg.panoptic_head.pixel_decoder.encoder.layer_cfg.self_attn_cfg.embed_dims = (
            base_channels
        )
        model_cfg.panoptic_head.pixel_decoder.encoder.layer_cfg.ffn_cfg.embed_dims = (
            base_channels
        )
        ...
        model_cfg.panoptic_head.transformer_decoder.layer_cfg.self_attn_cfg.embed_dims = (
            base_channels
        )
        model_cfg.panoptic_head.transformer_decoder.layer_cfg.cross_attn_cfg.embed_dims = (
            base_channels
        )
        model_cfg.panoptic_head.transformer_decoder.layer_cfg.ffn_cfg.embed_dims = (
            base_channels
        )
