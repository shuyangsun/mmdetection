...
class MaskTrackRCNN(BaseMOTModel):
    ...
    def loss(self, inputs: Tensor, data_samples: TrackSampleList, **kwargs) -> dict:
        ...
        if self.detector.with_rpn:
            ...
            rpn_results_list = [
                key_data_sample.proposals for key_data_sample in key_data_samples
            ]
        ...
        losses_track = self.track_head.loss(
            x, ref_x, rpn_results_list, data_samples, **kwargs
        )
