...
class MaskFormerFusionHead(BasePanopticFusionHead):
    ...
    def panoptic_postprocess(self, mask_cls: Tensor, mask_pred: Tensor) -> PixelData:
        ...
        panoptic_seg = torch.full(
            (h, w), self.num_classes, dtype=torch.int32, device=cur_masks.device
        )
    ...
    def semantic_postprocess(self, mask_cls: Tensor, mask_pred: Tensor) -> PixelData:
    ...
    def instance_postprocess(self, mask_cls: Tensor, mask_pred: Tensor) -> InstanceData:
