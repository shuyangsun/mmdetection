...
class StrongSORTTracker(SORTTracker):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            motion, obj_score_thr, reid, match_iou_thr, num_tentatives, **kwargs
        )
    ...
    def track(
        ...
        **kwargs
        ...
        if self.empty or bboxes.size(0) == 0:
            ...
            if model.with_cmc:
                num_samples = 1
                self.tracks = model.cmc.track(
                    self.last_img, img, self.tracks, num_samples, frame_id, metainfo
                )
            ...
            if self.with_reid:
                ...
                if len(active_ids) > 0:
                    ...
                    match_dists = (
                        1 - weight_motion
                    ) * reid_dists + weight_motion * motion_dists[valid_inds]
