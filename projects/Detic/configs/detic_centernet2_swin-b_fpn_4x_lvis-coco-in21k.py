...
custom_imports = dict(imports=["projects.Detic.detic"], allow_failed_imports=False)
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_roi_extractor=dict(
            ...
            roi_layer=dict(
                type="RoIAlign", output_size=7, sampling_ratio=0, use_torchvision=True
            ),
            out_channels=256,
...
optim_wrapper = dict(
    ...
    optimizer=dict(type="SGD", lr=0.01 * 4, momentum=0.9, weight_decay=0.00004),
    paramwise_cfg=dict(norm_decay_mult=0.0),
)

param_scheduler = [
    dict(type="LinearLR", start_factor=0.00025, by_epoch=False, begin=0, end=4000),
    dict(
        type="MultiStepLR",
        begin=0,
        end=25,
