...
class OpenVocabInstanceSegTab(OpenVocabObjectDetectionTab):
    ...
    model_info = {
        "xdecoder-tiny": {
            "model": "projects/XDecoder/configs/xdecoder-tiny_zeroshot_open-vocab-instance_coco.py",  # noqa
            "weights": "https://download.openmmlab.com/mmdetection/v3.0/xdecoder/xdecoder_focalt_last_novg.pt",  # noqa
        }
    }
...
class OpenVocabPanopticSegTab(OpenVocabObjectDetectionTab):
    ...
    model_info = {
        "xdecoder-tiny": {
            "model": "projects/XDecoder/configs/xdecoder-tiny_zeroshot_open-vocab-panoptic_coco.py",  # noqa
            "weights": "https://download.openmmlab.com/mmdetection/v3.0/xdecoder/xdecoder_focalt_last_novg.pt",  # noqa
        }
    }
    ...
    def create_ui(self):
        with gr.Row():
            ...
            with gr.Column():
                ...
                run_button.click(
                    self.inference,
                    inputs=[select_model, image_input, text_input, stuff_text_input],
                    outputs=output,
                )
        with gr.Row():
            example_images = gr.Dataset(
    ...
    def inference(self, model, image, text, stuff_text):
        ...
        results_dict = det_inferencer(
            image, texts=text, stuff_texts=stuff_text, return_vis=True, no_save_vis=True
        )
        vis = results_dict["visualization"][0]
        return vis
...
class OpenVocabSemSegTab(OpenVocabInstanceSegTab):
    ...
    model_info = {
        "xdecoder-tiny": {
            "model": "projects/XDecoder/configs/xdecoder-tiny_zeroshot_open-vocab-semseg_coco.py",  # noqa
            "weights": "https://download.openmmlab.com/mmdetection/v3.0/xdecoder/xdecoder_focalt_last_novg.pt",  # noqa
        }
    }
...
class ReferSegTab(OpenVocabInstanceSegTab):
    ...
    model_info = {
        "xdecoder-tiny": {
            "model": "projects/XDecoder/configs/xdecoder-tiny_zeroshot_open-vocab-ref-seg_refcocog.py",  # noqa
            "weights": "https://download.openmmlab.com/mmdetection/v3.0/xdecoder/xdecoder_focalt_last_novg.pt",  # noqa
        }
    }
...
class ImageCaptionTab:
    ...
    model_info = {
        "xdecoder-tiny": {
            "model": "projects/XDecoder/configs/xdecoder-tiny_zeroshot_caption_coco2014.py",  # noqa
            "weights": "https://download.openmmlab.com/mmdetection/v3.0/xdecoder/xdecoder_focalt_last_novg.pt",  # noqa
        }
    }
...
class ReferImageCaptionTab(OpenVocabInstanceSegTab):
    ...
    model_info = {
        "xdecoder-tiny": {
            "model": "projects/XDecoder/configs/xdecoder-tiny_zeroshot_ref-caption.py",  # noqa
            "weights": "https://download.openmmlab.com/mmdetection/v3.0/xdecoder/xdecoder_focalt_last_novg.pt",  # noqa
        }
    }
...
class TextToImageRetrievalTab:
    ...
    model_info = {
        "xdecoder-tiny": {
            "model": "projects/XDecoder/configs/xdecoder-tiny_zeroshot_text-image-retrieval.py",  # noqa
            "weights": "https://download.openmmlab.com/mmdetection/v3.0/xdecoder/xdecoder_focalt_last_novg.pt",  # noqa
        }
    }
