...
model = dict(
    ...
    encoder=dict(
        type="InstanceContextEncoder", in_channels=[512, 1024, 2048], out_channels=256
    ),
    decoder=dict(
        type="BaseIAMDecoder",
        in_channels=256 + 2,
...
train_cfg = dict(
    _delete_=True, type="IterBasedTrainLoop", max_iters=270000, val_interval=10000
)
# learning rate
param_scheduler = [
    dict(
...
default_hooks = dict(checkpoint=dict(by_epoch=False, interval=10000, max_keep_ckpts=3))
